...
public final class ItemNotificationBinding implements ViewBinding {
  ...
  private ItemNotificationBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout cardRoot,
      @NonNull TextView tvMessage, @NonNull TextView tvSubject, @NonNull TextView tvTime,
      @NonNull TextView tvUnreadDot) {
    this.rootView = rootView;
    this.cardRoot = cardRoot;
    this.tvMessage = tvMessage;
    this.tvSubject = tvSubject;
    this.tvTime = tvTime;
    this.tvUnreadDot = tvUnreadDot;
  }
  ...
  public static ItemNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_unread_dot;
      TextView tvUnreadDot = ViewBindings.findChildViewById(rootView, id);
      if (tvUnreadDot == null) {
        break missingId;
      }

      return new ItemNotificationBinding((LinearLayout) rootView, cardRoot, tvMessage, tvSubject,
          tvTime, tvUnreadDot);
    }
