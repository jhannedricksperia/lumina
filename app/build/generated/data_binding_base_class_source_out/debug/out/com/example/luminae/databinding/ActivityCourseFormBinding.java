...
public final class ActivityCourseFormBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCourseFormBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull TextInputEditText etAcronym, @NonNull TextInputEditText etDescription,
      @NonNull TextInputEditText etName, @NonNull LinearLayout llCampusLoading,
      @NonNull LinearLayout llCollegeLoading, @NonNull ProgressBar progressBar,
      @NonNull View spacerCampus, @NonNull View spacerCollege, @NonNull TextInputLayout tilAcronym,
  ...
  @NonNull
  public static ActivityCourseFormBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCourseFormBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_course_form, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCourseFormBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCourseFormBinding((LinearLayout) rootView, acvCampus, acvCollege,
          btnCancel, btnSave, etAcronym, etDescription, etName, llCampusLoading, llCollegeLoading,
          progressBar, spacerCampus, spacerCollege, tilAcronym, tilCampus, tilCollege,
          tilDescription, tilName, toolbar, tvError);
    }
