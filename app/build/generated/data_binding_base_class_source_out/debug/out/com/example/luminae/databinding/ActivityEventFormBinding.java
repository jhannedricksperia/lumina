...
public final class ActivityEventFormBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityEventFormBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull MaterialButton btnPickDate, @NonNull ImageView btnPickImage,
  ...
  @NonNull
  public static ActivityEventFormBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityEventFormBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_event_form, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityEventFormBinding bind(@NonNull View rootView) {
