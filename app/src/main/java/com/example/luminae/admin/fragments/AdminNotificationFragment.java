...
import com.example.luminae.databinding.FragmentAdminNotificationBinding;
...
public class AdminNotificationFragment extends Fragment {
    ...
    private FragmentAdminNotificationBinding b;
    ...
    private String filterRead = "All"; // All | Unread | Read
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        b = FragmentAdminNotificationBinding.inflate(inflater, container, false);
        ...
        b.chipUnread.setOnClickListener(v -> {
            filterRead = "Unread";
            applyFilter();
        });
        b.chipRead.setOnClickListener(v -> {
            filterRead = "Read";
            applyFilter();
        });
    ...
    private class NotifAdapter extends RecyclerView.Adapter<NotifAdapter.VH> {
        class VH extends RecyclerView.ViewHolder {
            final TextView tvMessage, tvSubject, tvTime, tvUnreadDot;
            final View cardRoot;
