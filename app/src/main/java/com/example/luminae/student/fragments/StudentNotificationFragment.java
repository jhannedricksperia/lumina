...
import com.example.luminae.databinding.FragmentStudentNotificationBinding;
...
public class StudentNotificationFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saved) {
        b    = FragmentStudentNotificationBinding.inflate(inflater, container, false);
                        ...
                        for (DocumentSnapshot doc : snap.getDocuments()) {
                            ...
                            boolean isForMe = uid.equals(targetUid)
                                    ...
                                    || (targetUid == null && targetCampus == null
                                        && targetCollege == null && targetCourse == null); // broadcast
