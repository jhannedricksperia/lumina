...
public class StaffProfileFragment extends Fragment {
    ...
    private FragmentStaffProfileBinding b;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saved) {
        b    = FragmentStaffProfileBinding.inflate(inflater, container, false);
    ...
    private void loadProfile() {
        ...
        db.collection("users").document(uid).get().addOnSuccessListener(doc -> {
            ...
            b.tvRole.setText("STAFF");
            b.tvDesignation.setText(desig);
