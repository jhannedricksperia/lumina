...
// ══════════════════════════════════════════════════════════════
//  CollegeManagementActivity  (copy-paste pattern for Course)
// ══════════════════════════════════════════════════════════════
...
public class CollegeManagementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.toolbar.setTitle("College Management");
    ...
    private void showFormDialog(DocumentSnapshot existing) {
        // Inline form with name, acronym, description fields
        ...
        @Override public void onBindViewHolder(VH h, int pos) {
            ...
            h.btnDelete.setOnClickListener(v ->
                    new MaterialAlertDialogBuilder(CollegeManagementActivity.this)
                            .setTitle("Delete College").setMessage("Delete " + doc.getString("name") + "?")
