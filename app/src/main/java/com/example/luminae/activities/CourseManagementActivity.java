...
public class CourseManagementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.toolbar.setTitle("Course Management");
        ...
        db.collection("courses").orderBy("name")
    ...
    private void applyFilter() {
        ...
        b.tvCount.setText(filtered.size() + " course(s)");
    ...
    private void showFormDialog(DocumentSnapshot existing) {
        ...
        EditText etName = new EditText(this);    etName.setHint("Course Name");
        EditText etAcronym = new EditText(this); etAcronym.setHint("Acronym (e.g. BSIT)");
        ...
        layout.addView(etName); layout.addView(etAcronym); layout.addView(etDesc);
    ...
    private class CrudAdapter extends RecyclerView.Adapter<CrudAdapter.VH> {
        class VH extends RecyclerView.ViewHolder {
            TextView tvName, tvStatus, tvAcronym, tvDesc, tvDateCreated, tvCreatedBy,
                     tvDateModified, tvModifiedBy, btnEdit, btnToggle, btnDelete;
            VH(View v) {
                super(v);
                tvName=v.findViewById(R.id.tv_name); tvStatus=v.findViewById(R.id.tv_status);
                tvAcronym=v.findViewById(R.id.tv_acronym); tvDesc=v.findViewById(R.id.tv_description);
                tvDateCreated=v.findViewById(R.id.tv_date_created); tvCreatedBy=v.findViewById(R.id.tv_created_by);
                tvDateModified=v.findViewById(R.id.tv_date_modified); tvModifiedBy=v.findViewById(R.id.tv_modified_by);
                btnEdit=v.findViewById(R.id.btn_edit); btnToggle=v.findViewById(R.id.btn_toggle_status);
        ...
        @Override public void onBindViewHolder(VH h, int pos) {
            ...
            if (acronym != null && !acronym.isEmpty()) { h.tvAcronym.setVisibility(View.VISIBLE); h.tvAcronym.setText(acronym); }
            else h.tvAcronym.setVisibility(View.GONE);
            ...
            h.btnDelete.setOnClickListener(v ->
                    new MaterialAlertDialogBuilder(CourseManagementActivity.this)
                            .setTitle("Delete Course").setMessage("Delete " + doc.getString("name") + "?")
