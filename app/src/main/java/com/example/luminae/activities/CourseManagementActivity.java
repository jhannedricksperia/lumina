...
public class CourseManagementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Open the add-course dialog when the FAB / add button is tapped.
    ...
    /**
     * Shows the course form dialog.
     *
     * @param existing Pass null to create a new course, or a DocumentSnapshot
