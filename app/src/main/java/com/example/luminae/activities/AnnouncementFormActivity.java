...
public class AnnouncementFormActivity extends AppCompatActivity {
    ...
    private TextView tvAudienceLabel, tvError;
    ...
    private String collection = "announcements";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(docId == null ? "Create Announcement" : "Edit Announcement");
        }
    ...
    private void initAudiencePicker() {
        if (!staffCourseId.isEmpty()) {
            // Fixed to specific course audience
            audienceType = "Course";
        ...
        if (!isUniversityWide && !staffCampusId.isEmpty()) {
            // fixed campus, optionally pick college/course
            loadCampusBoundOptions(staffCampusId, staffCollegeId);
            return;
        }

        // university-wide/admin scope
    ...
    private void loadCollegesForCampus(String campusId, boolean includeAllOption,
        ...
        db.collection("colleges")
                ...
                .addOnSuccessListener(snap -> {
                    ...
                    acvCollege.setAdapter(new ArrayAdapter<>(this,
                    ...
                    acvCollege.setOnItemClickListener((p, v, pos, id) -> {
                        ...
                        audienceLabel = sel.getString("name");
                        tvAudienceLabel.setText("Audience: " + audienceLabel);
    ...
    private void loadCoursesForCollege(String collegeId, boolean includeAllOption) {
        db.collection("courses")
                ...
                .addOnSuccessListener(snap -> {
                    ...
                    acvCourse.setAdapter(new ArrayAdapter<>(this,
    ...
    private void saveAnnouncement() {
        ...
        if (existingDoc == null) {
            ...
            db.collection(collection).add(data).addOnSuccessListener(ref -> {
                ActivityLogger.logAnnouncement(ActivityLogger.ACTION_CREATE, title, actorName);
            ...
            existingDoc.getReference().update(data).addOnSuccessListener(unused -> {
                ActivityLogger.logAnnouncement(ActivityLogger.ACTION_MODIFIED, title, actorName);
                finish();
            }).addOnFailureListener(e -> {
                setLoading(false);
                tvError.setText(e.getMessage());
